...
#pragma warning restore 0649
        ...
        protected virtual void GetNewObjects(out GameObject resultObjA, out GameObject resultObjB)
        {
            resultObjA = this.gameObject;
            resultObjB = Instantiate(this.gameObject, this.gameObject.transform.parent);
        }
